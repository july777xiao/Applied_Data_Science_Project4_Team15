...
ROOT       = Path.cwd()
clean_path = ROOT / "raw" / "restaurant_clean_clustered.csv"

# fallback: 如果clustered版本还没生成，用普通clean版本
if not clean_path.exists():
    clean_path = ROOT / "raw" / "restaurant_clean.csv"
    print("Warning: clustered CSV not found, using restaurant_clean.csv")
